...
public class AlertMessages {
    ...
    public static String FIRST_PHOTO_UPLOADED = "Photo uploaded & pending admin confirmation. To complete your profile, you must upload minimum 1 photo and minimum 1 video.";
    public static String PHOTO_UPLOADED = "Photo uploaded & pending admin confirmation.";
    public static String VIDEO_UPLOADED = "Video uploaded & pending admin confirmation.";
