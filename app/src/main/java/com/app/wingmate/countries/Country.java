package com.app.wingmate.countries;
...
public class Country {
    ...
    public Country(String name, ParseFile flagFile) {
        this.name = name;
    ...
    public ParseFile getFlagFile() {
        return flagFile;
    }

    public void setFlagFile(ParseFile flagFile) {
        this.flagFile = flagFile;
    }
